...
class View extends BuildHTML {
	...
	function draw_middle($content, $content_meta, $plugins, $content_menu) {
		...
		echo $centre_start;
		self::draw_sidebar($content_meta, $content_menu);
		if ($plugins != null) {
	...
	function draw_sidebar($content_meta, $content_menu) {
